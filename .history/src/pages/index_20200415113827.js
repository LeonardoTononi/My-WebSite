...
const Index = ({ data, location }) => {
	...
	return (
		<Layout location={location} title={siteTitle}>
			<SEO
				title='My web site'
				description='	I have two year of experience in web developing and I’m a self though programmer.
					I’m proficient with React and I can say to have built solid basis to deal with this
					framework.'
			/>
			<Header />
			<Project
...
export const pageQuery = graphql`
	query {
		...
		bestfiveImg: file(relativePath: { eq: "bestfive.png" }) {
			id
			childImageSharp {
				fluid(maxWidth: 300) {
