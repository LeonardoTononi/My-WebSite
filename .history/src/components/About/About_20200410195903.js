...
const About = () => {
	return (
		<AboutContainer>
			<Text>
				I have <strong>two year of experience</strong> in web developing and I’m a self though programmer. I’m proficient with <strong>React</strong>  and I can say to have built solid basis to deal with this framework. I also know how to deal with Redux and Gatsby.
			</Text>
